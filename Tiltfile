...
k8s_custom_deploy(
   ...
   apply_cmd="tanzu apps workload apply -f config/workload.yaml --live-update" +
       ...
       " --namespace " + NAMESPACE +
       " --yes >/dev/null" +
       " && kubectl get workload spring-sensors-rabbit --namespace " + NAMESPACE + " -o yaml",
...
k8s_resource('spring-sensors-rabbit', port_forwards=["8080:8080"],
   extra_pod_selectors=[{'serving.knative.dev/service': 'spring-sensors-rabbit'}])
